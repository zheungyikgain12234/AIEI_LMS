...
insert into course_sections (course_id, section_code, role_label, term, schedule_text, day_of_week, start_time, end_time, location, lecturer_id, capacity, delivery_mode, cohort_id, status) values
  ('44444444-4444-4444-4444-444444444401', 'TN01-CLS-PY402-A01', 'Primary Instructor', 'AY2025 Term 2', 'Monday 09:00–10:30 • Innovation Hall 204', 'Monday', '09:00', '10:30', 'Innovation Hall 204', '11111111-1111-1111-1111-111111111101', 50, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444407', 'TN01-CLS-DATA501-B02', 'Primary Instructor', 'AY2025 Term 2', 'Tuesday 13:00–14:45 • Data Lab 3B', 'Tuesday', '13:00', '14:45', 'Data Lab 3B', '11111111-1111-1111-1111-111111111101', 45, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444408', 'TN01-CLS-AI301-C01', 'Co-Lecturer', 'AY2025 Term 2', 'Friday 14:00–17:00 • AI Research Lab 1', 'Friday', '14:00', '17:00', 'AI Research Lab 1', '11111111-1111-1111-1111-111111111101', 35, 'online', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444402', 'TN01-CLS-OSHE101-A1', 'Lead Instructor', 'AY2025 Term 2', 'Monday 11:00–12:30 • Safety Training Center', 'Monday', '11:00', '12:30', 'Safety Training Center', '11111111-1111-1111-1111-111111111102', 56, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444409', 'TN01-CLS-SAF204-H03', 'Lead Instructor', 'AY2025 Term 2', 'Thursday 14:00–17:30 • Hazmat Simulation Hall', 'Thursday', '14:00', '17:30', 'Hazmat Simulation Hall', '11111111-1111-1111-1111-111111111102', 34, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444410', 'TN01-CLS-ML800-GRAD', 'Graduate', 'AY2025 Term 2', 'Monday 14:00–18:00 • Grad Seminar Room 5', 'Monday', '14:00', '18:00', 'Grad Seminar Room 5', '11111111-1111-1111-1111-111111111103', 50, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444411', 'TN01-CLS-DL901-DOC', 'Doctoral Seminar', 'AY2025 Term 2', 'Wednesday 14:00–18:00 • Doctoral Seminar Hall', 'Wednesday', '14:00', '18:00', 'Doctoral Seminar Hall', '11111111-1111-1111-1111-111111111103', 45, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444412', 'TN01-CLS-RL705-ADV', 'Advanced Lab', 'AY2025 Term 2', 'Friday 08:30–12:30 • Robotics Lab 2', 'Friday', '08:30', '12:30', 'Robotics Lab 2', '11111111-1111-1111-1111-111111111103', 30, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444406', 'TN01-CLS-LEAD400-E1', 'Section E1', 'AY2025 Term 2', 'Tuesday 18:00–21:00 • Executive Boardroom', 'Tuesday', '18:00', '21:00', 'Executive Boardroom', '11111111-1111-1111-1111-111111111104', 28, 'physical', (select id from cohorts where name = 'Executive Cohort 2025'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444414', 'TN01-CLS-COMM102-C3', 'Section C3', 'AY2025 Term 2', 'Thursday 16:00–19:00 • Communication Studio C', 'Thursday', '16:00', '19:00', 'Communication Studio C', '11111111-1111-1111-1111-111111111104', 40, 'physical', (select id from cohorts where name = 'Executive Cohort 2025'), 'in_progress'),
  -- Dr. Emmett Brown's classes (Lecturer Portal demo identity):
  ('44444444-4444-4444-4444-444444444413', 'TN01-CLS-NLP620-A01', 'Primary Instructor', 'AY2025 Term 2', 'Wednesday 10:00–12:00 • Language Systems Lab', 'Wednesday', '10:00', '12:00', 'Language Systems Lab', '11111111-1111-1111-1111-111111111106', 30, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444417', 'TN01-CLS-AI512-01', 'Primary Instructor', 'AY2025 Term 2', 'Thursday 13:00–16:00 • Autonomy Systems Lab', 'Thursday', '13:00', '16:00', 'Autonomy Systems Lab', '11111111-1111-1111-1111-111111111106', 22, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  ('44444444-4444-4444-4444-444444444403', 'TN01-CLS-AI330-A01', 'Primary Instructor', 'AY2025 Term 2', 'Tuesday 10:00–12:00 • AI Studio 2', 'Tuesday', '10:00', '12:00', 'AI Studio 2', '11111111-1111-1111-1111-111111111106', 25, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'in_progress'),
  -- Unassigned sections needing lecturer allocation:
  ('44444444-4444-4444-4444-444444444415', 'TN01-CLS-CYBER202-02', 'Unassigned', 'AY2025 Term 2', 'TBD', null, null, null, null, null, 34, 'physical', (select id from cohorts where name = 'January 2025 Intake'), 'scheduled'),
  ('44444444-4444-4444-4444-444444444416', 'TN01-CLS-CLOUD410-01', 'Unassigned', 'AY2025 Term 2', 'TBD', null, null, null, null, null, 50, 'online', (select id from cohorts where name = 'January 2025 Intake'), 'scheduled');
...
insert into course_tags (course_id, tag_id) values
  ...
  ('44444444-4444-4444-4444-444444444425', '77777777-7777-7777-7777-777777777701'); -- DATA-610: MANDATORY
